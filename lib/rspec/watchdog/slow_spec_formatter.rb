...
class Rspec::Watchdog::SlowSpecFormatter
  ...
  def initialize(output)
    @output = output
    @show_logs = RspecWatchdog.config.show_logs
    @watchdog_api_url = RspecWatchdog.config.watchdog_api_url
    @watchdog_api_token = RspecWatchdog.config.watchdog_api_token
  end
